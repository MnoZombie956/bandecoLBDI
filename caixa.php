  ...
  <body>
    ...
    <main>
      ...
      <div class="container">
        ...
        <b><br>Consulta Avançada</b> <input type="checkbox" id="avancado" onclick="mostrarAvancado()">
        <div id="avancadoP" style="display:none">
          <?php
          ...
          <form method="post">
             <div class="container">
              ...
              <input type="text" placeholder="SQL command" name="cmd" required>

              <button type="submit" name="subcmd">Confirma</button>
